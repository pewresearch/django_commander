...
from django_commander.settings import COMMAND_BASE_MODEL, COMMAND_BASE_MANAGER


class LoggedExtendedModel(COMMAND_BASE_MODEL):
...
class Command(COMMAND_BASE_MODEL):
    ...
    def command_class(self):
        ...
        return get_project_commands()[self.name]
...
class CommandLog(COMMAND_BASE_MODEL):
